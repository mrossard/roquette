...
class OAuth2Authenticator extends AbstractAuthenticator
{
    public function __construct(
        ...
        #[Autowire(env: 'OAUTH_TOKEN_URL')] private string $tokenUrl,
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        $redirectUri = $this->redirectUri ?: $this->urlGenerator->generate('app_oauth_check', [], UrlGeneratorInterface::ABSOLUTE_URL);
        ...
        return new SelfValidatingPassport(
            new UserBadge($user->getUserIdentifier(), static function () use ($user) {
                return $user;
            })
        );
    }
